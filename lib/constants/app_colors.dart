...
class AppColors {
   ...
   static const primary = Color(0xFF0D47A1); // Deep Ocean Blue
  static const secondary = Color(0xFF1976D2); // Medium Blue
  static const accent = Color(0xFF42A5F5); // Light Blue

  static const warning = Color(0xFFF9A825); // Delay
  static const error = Color(0xFFD32F2F); // Cancel

  static const background = Color(0xFFeff7ff);
  static const card = Colors.white;

  static const textPrimary = Color(0xFF0A1F44);
  static const textSecondary = Color(0xFF6B7280);
  // Common Colors
  // static const Color primary = Color(0xFFc5003e);
